...
namespace PropertyOrFieldInfoPackage {
	public partial class PropertyOrFieldInfo {
		...
		/// <inheritdoc />
		/// <summary>
		///  Gets a <see cref="T:System.Reflection.MemberTypes"></see> value indicating the type of the member — method, constructor, event,
		///  and so on.
		/// </summary>
		...
		/// <param name="inherit">
		///  true to search this member's inheritance chain to find the attributes; otherwise, false. This parameter is ignored
		///  for properties and events.
		/// </param>
		/// <returns>
		///  An array that contains all the custom attributes applied to this member, or an array with zero elements if no attributes are
		///  defined.
		/// </returns>
		/// <exception cref="T:System.InvalidOperationException">
		///  This member belongs to a type that is loaded into the reflection-only context. See
		///  <see cref="!:~/docs/framework/reflection-and-codedom/how-to-load-assemblies-into-the-reflection-only-context.md">
		...
		///  <paramref name="attributeType">attributeType</paramref> have been applied.
		/// </returns>
		...
		/// </param>
		/// <returns>
		///  true if one or more instances of <paramref name="attributeType">attributeType</paramref> or any of its derived types is applied to
